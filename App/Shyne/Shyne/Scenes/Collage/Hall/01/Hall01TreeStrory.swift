...
var hall01EFd14 = Node(withText: NSLocalizedString("Quando você chegar em casa você lê.\n Ok?", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice03")
...
var hall01SBTd03 = Node(withText: NSLocalizedString("E você comprar a coisa errada?", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice03")
