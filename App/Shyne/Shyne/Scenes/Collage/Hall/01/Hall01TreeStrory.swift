...
var hall01Root = Node(withText: NSLocalizedString("Você viu o email?", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice01")

var hall01ETRoot = Node(withText: NSLocalizedString("Sim, eu vi!", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice01")
var hall01ETd02 = Node(withText: NSLocalizedString("Legal né? \nVai ter um concurso!", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice01")
...
var hall01ETd05 = Node(withText: NSLocalizedString("É a empresa que você mais\n gosta e você só diz 'é'.", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice01")
...
var hall01ETd08 = Node(withText: NSLocalizedString("Claro, você é a pessoa que mais ama\n essa empresa, depois de mim é claro.", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice03")
var hall01ETd09 = Node(withText: NSLocalizedString("Ha ha ha.", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Laught03")
var hall01ETd10 = Node(withText: NSLocalizedString("Mas tem que fazer um vídeo, \ne eu não gosto nem de bater foto...", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice02")
var hall01ETd11 = Node(withText: NSLocalizedString("Deixa disso. É para conhecer\n a Avocad Games.", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice01")
var hall01ETd12 = Node(withText: NSLocalizedString("Se você se inscrever eu\n até te ajudo a fazer o vídeo.", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice02")
var hall01ETd13 = Node(withText: NSLocalizedString("Mas você não quer \nse inscrever também?", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice01")
var hall01ETd14 = Node(withText: NSLocalizedString("Claro que quero. Mas prefiro\n que você vá, é seu sonho a muito tempo!", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice03")
...
var hall01EFRoot = Node(withText: NSLocalizedString("Que email?", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice01")
...
var hall01EFd04 = Node(withText: NSLocalizedString("Você não lia seus emails\n todo dia de manhã?", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice02")
var hall01EFd05 = Node(withText: NSLocalizedString("Ás vezes eu esqueço.", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice05")
var hall01EFd06 = Node(withText: NSLocalizedString("Ás vezes..", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice01")
var hall01EFd07 = Node(withText: NSLocalizedString("Afinal, que email?", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice02")
var hall01EFd08 = Node(withText: NSLocalizedString("Pega seu telefone, e lê o email.", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice03")
...
var hall01EFd11 = Node(withText: NSLocalizedString("Não tenho!", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice04")
...
var hall01EFd14 = Node(withText: NSLocalizedString("Quando você chegar em casa\nvocê lê. Ok?", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice03")
...
var hall01EFd16 = Node(withText: NSLocalizedString("Vê se não esquece.", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_voice01")
...
var hall01SBTRoot = Node(withText: NSLocalizedString("Vou tentar\npuxar conversa.", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode)
var hall01SBTd02 = Node(withText: NSLocalizedString("Já aconteceu de alguém\n mandar você comprar algo..", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice01")
var hall01SBTd03 = Node(withText: NSLocalizedString("E você comprar\na coisa errada?", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice03")
...
var hall01SBTd05 = Node(withText: NSLocalizedString("Ha ha ha.", comment: ""), withChoices: [], inNodeNamed: hall01AnaNameNode, audioName: "ana_laught03")
...
var hall01SBTd07 = Node(withText: NSLocalizedString("É, comigo também não.", comment: ""), withChoices: [], inNodeNamed: hall01PlayerNameNode, audioName: "felipe_Voice03")

func hall01MakeTree(){
    //TODO: Definir o filho de hall01Root
    hall01Root.childrens = []
    hall01ETd16.childrens = []
    hall01EFd16.childrens = []
