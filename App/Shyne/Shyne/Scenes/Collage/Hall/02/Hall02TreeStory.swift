...
var hall02Fd05 = Node(withText: NSLocalizedString("Você quem vai organizar o trabalho?", comment: ""), withChoices: [], inNodeNamed: hall02AnaNameNode, audioName: "ana_Voice02")
var hall02Fd06 = Node(withText: NSLocalizedString("Sim, Sim, Mas queria que você me ajuda-se", comment: ""), withChoices: [], inNodeNamed: hall02PlayerNameNode, audioName: "felipe_Voice01")
