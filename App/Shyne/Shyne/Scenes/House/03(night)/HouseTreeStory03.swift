...
var house03d01SBTc01d03 = Node(withText: NSLocalizedString("Tirando o pão doce, tudo bem...", comment: ""), withChoices: [], inNodeNamed:house03PlayerNameNode, audioName: "felipe_Voice03")
...
var house03NTd04SBFc02d03 = Node(withText: NSLocalizedString("Ha ha ha.", comment: ""), withChoices: [], inNodeNamed: house03PlayerNameNode, audioName: "felipe_Laught01")
...
var house03d07 = Node(withText: NSLocalizedString("Ok, eu tenho que\nir para o quarto.", comment: ""), withChoices: [], inNodeNamed: house03PlayerNameNode, audioName: "felipe_Voice01")
