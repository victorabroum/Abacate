...
var bakery01d02 = Node(withText: NSLocalizedString("  Desculpe.\nO que você deseja?", comment: ""), withChoices: [], inNodeNamed: bakery01BakerNameNode, audioName: "bakery_Voice03")
var bakery01d03 = Node(withText: NSLocalizedString("Me veja um real\nde pão francês.", comment: ""), withChoices: [], inNodeNamed: bakery01PlayerNameNode, audioName: "felipe_Voice05")//Acao de trazer o pao
...
var bakery01d07 = Node(withText: NSLocalizedString("Tudo bem!", comment: ""), withChoices: [], inNodeNamed: bakery01PlayerNameNode, audioName: "felipe_Voice03")//chave do pao frances
